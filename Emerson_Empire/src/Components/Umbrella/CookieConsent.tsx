    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className="z-[100] fixed bottom-0 left-0 right-0"
          role="dialog"
          ...
          <div className="bg-[#0D0118]/95 backdrop-blur-md px-6 sm:px-10 lg:px-16 py-5">
            <div className="flex sm:flex-row flex-col justify-between items-start sm:items-center gap-5 mx-auto max-w-7xl">
              ...
              <div className="flex-1">
                <p className="mb-1 font-semibold text-[#F5F0E8] text-[13px] tracking-wide heading">
                  We use cookies
                </p>
                <p className="text-[#F5F0E8]/55 text-[12px] leading-[1.7] body max-w-2xl">
              ...
              <div className="flex items-center gap-3 shrink-0">
                <button
                  ...
                  className="px-5 py-2.5 border border-white/15 hover:border-white/30 rounded-sm font-semibold text-[11px] text-[#F5F0E8]/60 hover:text-[#F5F0E8] uppercase tracking-[2.5px] transition-all duration-200 body"
                >
                  Deny
                </button>
                <button
                  onClick={() => handleConsent('accepted')}
                  className="px-6 py-2.5 rounded-sm font-semibold text-[11px] text-[#12022A] uppercase tracking-[2.5px] transition-all duration-200 body"
