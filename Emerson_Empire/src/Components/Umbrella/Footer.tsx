        ...
        <div className="gap-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1fr]">
          ...
          <div className="flex flex-col items-center sm:items-start sm:text-left text-center">
            ...
            <div className="flex justify-center sm:justify-start gap-2.5">
              ...
              {/* Facebook */}
              <a href="https://www.facebook.com/profile.php?id=61589315787826 EE" aria-label="Facebook" className="flex justify-center items-center bg-white/8 hover:bg-[#C9A84C]/20 border border-white/10 hover:border-[#C9A84C]/30 rounded-md w-9 h-9 transition-colors duration-200">
                <svg aria-hidden="true" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-white/60">
          ...
          <div className="flex flex-col items-center sm:items-start sm:text-left text-center">
            ...
            <ul className="flex flex-col items-center sm:items-start gap-4">
              <li className="flex items-start gap-2.5">
                ...
                <a href="mailto:admin@theemersonempire.info" className="text-[13px] text-white/45 hover:text-[#C9A84C] break-all tracking-wide transition-colors duration-200">
