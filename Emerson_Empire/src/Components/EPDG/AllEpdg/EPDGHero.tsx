    ...
    >
      ...
      <div className="z-10 relative mx-auto px-5 sm:px-8 lg:px-10 py-10 sm:py-20 max-w-screen-7xl">
        <div className="items-start gap-6 sm:gap-10 grid xl:grid-cols-[1.5fr_0.9fr]">
          ...
          <div className="space-y-5 sm:space-y-8">
            <div className="flex flex-wrap gap-2 sm:gap-3">
              {['Entry-Level Growth', 'Executive Scaling'].map((label) => (
                <span
                  key={label}
                  className="bg-white/10 px-3 sm:px-4 py-1.5 sm:py-2 border border-white/20 rounded-[28px] font-semibold text-[11px] sm:text-[15px] text-white uppercase tracking-[0.2em]"
                >
                  {label}
                </span>
              ))}
            ...
            <div className="flex flex-wrap gap-3">
              <button className="bg-[#0f2049] hover:bg-white/10 px-4 sm:px-5 py-2.5 sm:py-3 border border-white/30 rounded-lg font-semibold text-[10px] sm:text-[11px] text-white uppercase tracking-[0.18em] transition cursor-pointer">
          ...
          <div className="grid grid-cols-2 xl:grid-cols-1 gap-3 sm:gap-5">
            <div className="gap-2 sm:gap-4 grid bg-white/10 shadow-2xl shadow-slate-950/20 backdrop-blur-xl p-4 sm:p-6 border border-white/20 rounded-[18px]">
              <div className="text-slate-200 text-[10px] sm:text-xs uppercase tracking-[0.2em]">Remote Internship</div>
            ...
            <div className="gap-2 sm:gap-4 grid bg-white/10 shadow-2xl shadow-slate-950/20 backdrop-blur-xl p-4 sm:p-6 border border-white/20 rounded-[18px]">
              <div className="text-slate-200 text-[10px] sm:text-xs uppercase tracking-[0.2em]">Advisory Tracks</div>
