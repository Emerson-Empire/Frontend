      ...
      <div className="px-6 mx-auto sm:px-8 max-w-screen-7xl">
        <div className="items-center gap-12 grid lg:grid-cols-[0.9fr_1.1fr]">
          <div>
            ...
            <div className="space-y-6">
              {[
                ...
                <div key={item.title}>
                  <p className="mb-2 text-2xl font-semibold text-slate-950">{item.title}</p>
          ...
          <div className="relative bg-white shadow-[0_40px_120px_-70px_rgba(15,32,73,0.2)] border border-slate-200 rounded-4xl overflow-hidden">
            <img  alt="Professional growth" className="object-cover w-full h-full min-h-4xl" />
            <div className="absolute px-4 py-3 border shadow-xl bottom-6 left-6 bg-white/95 shadow-slate-900/10 border-slate-200 rounded-3xl max-w-55">
