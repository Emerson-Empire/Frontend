      ...
      <div className="gap-8 grid xl:grid-cols-2">
        <div className="bg-white shadow-[0_22px_80px_rgba(15,32,73,0.12)] hover:shadow-[0_30px_100px_rgba(15,32,73,0.15)] border border-slate-200 rounded-4xl overflow-hidden transition">
          ...
          <div className="flex justify-center -mt-5 mb-6">
            <div className="inline-flex z-10 relative items-center gap-2 bg-[#4B1E91] shadow-sm backdrop-blur-sm px-4 py-2 border border-white/50 rounded-full font-semibold text-[10px] text-white uppercase tracking-[0.24em] hover:scale-125">
          ...
          <div className="p-8">
            ...
            <button className="bg-[#4B1E91] hover:bg-slate-100 shadow-lg px-6 py-3 rounded-lg font-semibold text-[11px] text-white hover:text-slate-950 uppercase tracking-[0.18em] transition cursor-pointer">Get My Portfolio Started</button>
          </div>
        </div>

        <div className="bg-[#12022A] shadow-2xl rounded-4xl overflow-hidden text-white transition">
