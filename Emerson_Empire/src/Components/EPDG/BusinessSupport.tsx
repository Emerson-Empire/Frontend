    ...
    <section id="how-it-works" className="py-16 bg-slate-50">
      <div className="max-w-screen-xl mx-auto px-6 sm:px-8">
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          {STEPS.map((step) => (
            <div key={step.number} className="group overflow-hidden rounded-[15px] border border-slate-200 bg-white transition hover:-translate-y-1 hover:shadow-[0_40px_120px_-60px_rgba(15,32,73,0.18)]">
              <div className="relative h-[450px] overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 right-0 px-6 pb-8 pt-6 backdrop-blur-sm border-t border-white/20">
        ...
        <div className="mt-12 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
          ...
          <button className="inline-flex items-center justify-center rounded-[8px] border border-slate-300 bg-white px-8 py-3 text-sm font-semibold uppercase tracking-[0.18em] text-slate-950 transition hover:bg-slate-100 cursor-pointer">
            Learn More
          </button>
        </div>
      </div>
